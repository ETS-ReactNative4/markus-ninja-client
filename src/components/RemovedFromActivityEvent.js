...
class RemovedFromActivityEvent extends React.Component {
  get classes() {
    const {className} = this.props
    return cls("RemovedFromActivityEvent rn-list-preview", className)
  }
...
export default createFragmentContainer(RemovedFromActivityEvent, graphql`
  fragment RemovedFromActivityEvent_event on RemovedFromActivityEvent {
    activity {
      name
      number
      resourcePath
