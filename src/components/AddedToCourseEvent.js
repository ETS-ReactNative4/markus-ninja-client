...
class AddedToCourseEvent extends React.Component {
  get classes() {
    const {className} = this.props
    return cls("AddedToCourseEvent rn-list-preview", className)
  }
...
export default createFragmentContainer(AddedToCourseEvent, graphql`
  fragment AddedToCourseEvent_event on AddedToCourseEvent {
    course {
      name
      number
      resourcePath
